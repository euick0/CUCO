...
(function(serial, ctime, usage) {
  ...
  var ctimeEl = findBySelectors([
    'input[name=c]', 'input[id=c]', 'input[name=ctime]', 'input[id=ctime]', 'input[name*=certified i]',
  ...
  var usageEl = findBySelectors([
    'input[name=u]', 'input[id=u]', 'input[name=usage]', 'input[name=usagecounter]', 'input[id*=usage i]',
